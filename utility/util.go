...
<body>
  <div style="border: 1px solid black; min-width: 800px;">
    <div style="display: flex; justify-content: space-between;">
      <h1 style="font-weight: bold; margin: 0;">GIME</h1>
      <div style="display: flex; flex-direction: column;">
        <p>REG: 123000123000</p>
        <p>Gime@aitech.co | +6213123213123</p>
      </div>
    </div>
    <section style="display: flex; justify-content: space-between;">
      <div>
        ...
        <div style="display: flex; flex-direction: column; width: 30vw;">
          ...
          <div><strong>INVOICE DATE:</strong>` + tanggal + `</div>
    ...
    <section style="width: 100%; margin: 24px 0;">
      <div style="background-color: #f9f9fa; border: 2px solid #dfe4ea; padding: 16px; border-radius: 15px;">
        <div style="display: flex; justify-content: space-between;">
        ...
        <div style="display: flex; justify-content: space-between">
          <div>Credit card fee (if using):</div>
          <div>$25.00</div>
        </div>
        <div style="display: flex; justify-content: space-between; font-weight: bold;">
          <div>Amount due on ` + due + `:</div>
          <div>6,025.50 NZD</div>
        </div>
      </div>
    </section>
    <div style="display: flex; justify-content: space-between;">
      <div style="display: flex; flex-direction: column;">
        <h2 style="font-weight: bold;">PAYMENT INSTRUCTION</h2>
        <div style="display: flex; flex-direction: column;">
          <p>Bank name: ABC Bank</p>
          <p>Account number: 12-1234-123456-12</p>
          <p><strong>Please use ` + invoiceNumber + ` as a reference number</strong></p>
        </div>
        <p>For any questions please contact us at Gime@aitech.co</p>
      </div>
      <div style="display: flex; flex-direction: column;">
        <p>Pay Online</p>
        <a href="https://buy.stripe.com/" style="text-decoration: underline; font-weight: bold;">https://buy.stripe.com/</a>
      </div>
    </div>
  </div>
</body>
